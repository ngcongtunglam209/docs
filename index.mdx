...
Nếu bạn muốn đóng góp, vui lòng tạo pull request vào nhánh `main`.
...
Điểm mạnh cốt lõi của Yuna nằm ở khả năng tuỳ biến sâu, từ đó cá nhân hóa hành vi của bot sao cho phù hợp hoàn hảo với phong cách cộng đồng của mình. Dưới đây là các tính năng mà Yuna mang lại cho máy chủ của bạn:

<Card
  title="Thêm Yuna vào máy chủ của bạn"
